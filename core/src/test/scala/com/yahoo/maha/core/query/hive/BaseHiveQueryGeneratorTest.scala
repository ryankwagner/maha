    ...
    ColumnContext.withColumnContext { implicit dc: ColumnContext =>
      ...
      .toPublicFact("s_stats",
        Set(
          ...
          PubCol("campaign_id", "Campaign ID", InEqualityOr),
          PubCol("account_id", "Advertiser ID", InEqualityOr),
        ...
        Set(
          ...
          PublicFactCol("avg_pos", "Average Position", InEqualityOr),
          PublicFactCol("max_bid", "Max Bid", FieldEquality ++ Set(OrFilterOperation)),
